      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-full mb-6"
          >
          ...
          {filteredNews.map((item, index) => (
            ...
            >
              ...
              <motion.div
                ...
                className="absolute -left-3 top-0 w-6 h-6 bg-gradient-to-r from-blue-600 to-blue-800 rounded-full border-4 border-gray-50 dark:border-black"
              >
              ...
              <Link href={`/news/${item.id}`} className="block group">
                <div className="bg-white dark:bg-gray-900 backdrop-blur-sm rounded-2xl overflow-hidden shadow-lg border border-gray-300 dark:border-blue-900 hover:shadow-2xl hover:scale-[1.02] transition-all duration-300">
                  <div className="flex flex-col md:flex-row">
                    {item.image && (
                      <div className="relative md:w-80 h-64 bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900/30 dark:to-blue-800/30">
                        <Image
                          src={item.image}
                          alt={item.title}
                          fill
